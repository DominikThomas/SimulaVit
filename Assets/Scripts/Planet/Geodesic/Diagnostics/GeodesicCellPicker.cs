...
public class GeodesicCellPicker : MonoBehaviour
{
    ...
    private void CacheSelectedStaticPopupText(int cellIndex)
    {
        ...
        compactHeader.Append("Cell index: ").Append(cellIndex)
            .Append("\nClassification: ").Append(planetGenerator.GetGeodesicCellOceanClassification(cellIndex))
    ...
    private void DrawPopupHeader()
    {
        ...
        string classification = planetGenerator != null ? planetGenerator.GetGeodesicCellOceanClassification(selectedCellIndex) : "Land";
