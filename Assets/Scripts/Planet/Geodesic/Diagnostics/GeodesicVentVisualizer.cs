...
public sealed class GeodesicVentVisualizer : MonoBehaviour
{
    ...
    public void Initialize(GeodesicExperiencedTemperatureField temperatureField, PlanetGenerator generator)
    {
        ...
        Debug.Log($"[GeodesicVentVisualizer] outlets={markerCount}, authority=GeodesicOceanResourceField compactOutlets via experienced-temperature anchored records, anchors=completed visible terrain", this);
    }
