...
| `Assets/Scripts/ReplicatorMetabolismSystem.cs` | `MetabolismTick`, `Process*ReactionBacked`, `TryPhotosynthesisEnergyGain`, `TryPhotosynthAnoxicDarkFallback`, starvation timer updates | Runtime resource consumption/production, energy/carbon storage, death pressure, O2 inhibition scope, photosynthesis light/layer behavior. |
