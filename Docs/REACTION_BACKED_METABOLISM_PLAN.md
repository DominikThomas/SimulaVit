...
- `Assets/Scripts/Planet/Environment/ResourceSimulation/PlanetResourceMap.cs` (resource access/write paths + telemetry compatibility)
...
- Resource types, layered-ocean write/fallback telemetry: `Assets/Scripts/Planet/Environment/ResourceSimulation/PlanetResourceMap.cs`
